            ...
            try:
                ...
                while username is None:
                    if not username:
                        ...
                        raw_value = moves.input(force_str('%s: ' % input_msg))
                ...
                for field_name in self.UserModel.REQUIRED_FIELDS:
                    ...
                    while user_data[field_name] is None:
                        raw_value = moves.input(force_str('%s: ' % capfirst(field.verbose_name)))
                        try:
                ...
                self.stdout.write(
                    ...
                    "You can run `manage.py create_user` in your project "
